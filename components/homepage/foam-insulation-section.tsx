...
export function FoamInsulationSection() {
    return (
        <section className="w-full bg-background" dir="rtl">
            {/* 1. Hero Introduction */}
            <div className="relative bg-primary/5 py-20 px-4 md:px-6">
                ...
                <div className="container mx-auto relative z-10 text-center">
                    ...
                    <h2 className="text-4xl font-extrabold tracking-tight lg:text-5xl mb-6">
                        عزل الفوم (البولي يوريثان): الحماية الشاملة لمنزلك
                    </h2>
                    <p className="max-w-3xl mx-auto text-xl text-muted-foreground leading-relaxed">
                        اكتشف لماذا يعتبر عزل الفوم الحل الأمثل والأكثر كفاءة لعزل الأسطح في المملكة العربية السعودية. حماية مزدوجة (حرارية ومائية) في طبقة واحدة، توفير هائل في الطاقة، وضمان يمتد لعقود.
                    </p>
                </div>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-900/50 py-20">
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    <Tabs defaultValue="thermal" className="w-full max-w-4xl mx-auto">
                        ...
                        <TabsContent value="thermal" className="mt-8">
                            <Card>
                                <CardHeader>
            ...
            <div className="bg-red-50 dark:bg-red-950/10 py-20 border-y border-red-100 dark:border-red-900/20">
                <div className="container mx-auto px-4 md:px-6">
