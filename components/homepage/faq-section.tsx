  ...
  const faqs = [
    {
      ...
      answer:
        "نقدم جميع أنواع العزل: العزل المائي باستخدام البيتومين والأغشية العازلة، عزل الفوم (البولي يوريثان) للعزل الحراري والمائي، العزل الأسمنتي التقليدي، عزل الخزانات الداخلي والخارجي، بالإضافة إلى خدمة كشف التسربات باستخدام أحدث الأجهزة.",
    },
    {
      question: "كم تستغرق عملية عزل السطح؟",
      answer:
        "تختلف المدة حسب نوع العزل ومساحة السطح. عادة، عزل الفوم يستغرق يوماً واحداً للأسطح المتوسطة، العزل المائي من 2-3 أيام، والعزل الأسمنتي من 3-5 أيام. نلتزم بجدول زمني واضح ونخبر العميل بالمدة بدقة بعد المعاينة.",
    },
    {
