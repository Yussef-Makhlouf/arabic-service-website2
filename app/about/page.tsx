                        ...
                        <div className="grid gap-16 lg:grid-cols-2 lg:gap-20 items-center">
                            <div className="space-y-8">
                                ...
                                <p className="text-xl text-muted-foreground leading-loose max-w-[600px] text-justify">
                                    شركة العزل المتقدم لعزل الفوم بالرياض هي وجهتك الأولى لحلول العزل المائي والحراري المتكاملة، كشف التسربات، ورش الفوم البولي يوريثان عالي الكثافة. نمتلك خبرة تمتد لأكثر من 15 سنه في السوق السعودي، ونقدم خدماتنا للمباني السكنية، التجارية، والصناعية بجودة لا تُضاهى وضمان يصل إلى 15 عامًا.
                                </p>
                        ...
                        <div className="grid gap-16 lg:grid-cols-2 items-center">
                            ...
                            <div className="space-y-8 order-1 lg:order-2">
                                ...
                                <ul className="grid sm:grid-cols-2 gap-4 pt-4">
                                    {[
                                        "فريق فني معتمد وذو خبرة تزيد عن 15 سنه",
